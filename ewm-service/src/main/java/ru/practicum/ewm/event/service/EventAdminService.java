...
public interface EventAdminService {
    ...
    List<EventRespDto> findEventsByInitiator(Long initiatorId, PageParam pageParam);

    List<EventRespDto> findEventsByInitiators(List<Long> initiatorsId, PageParam pageParam);
}
